...
input CreationCreateManyWithoutUserIdInput {
...
input CreationCreateWithoutUserIdInput {
  name: String!
  description: String!
  photo: String!
  comments: CommentCreateManyWithoutCreationInput
...
input CreationUpdateManyWithoutUserIdInput {
  create: [CreationCreateWithoutUserIdInput!]
  delete: [CreationWhereUniqueInput!]
  connect: [CreationWhereUniqueInput!]
  set: [CreationWhereUniqueInput!]
  disconnect: [CreationWhereUniqueInput!]
  update: [CreationUpdateWithWhereUniqueWithoutUserIdInput!]
  upsert: [CreationUpsertWithWhereUniqueWithoutUserIdInput!]
...
input CreationUpdateWithoutUserIdDataInput {
  name: String
  description: String
  photo: String
  comments: CommentUpdateManyWithoutCreationInput
...
input CreationUpdateWithWhereUniqueWithoutUserIdInput {
...
input CreationUpsertWithWhereUniqueWithoutUserIdInput {
  where: CreationWhereUniqueInput!
